package onix.command.impl;

import net.minecraft.text.Text;
import net.minecraft.util.Formatting;
import onix.command.Command;
import onix.command.helpers.TabCompleteHelper;
import onix.modules.impl.misc.AutoBuy;
import onix.screens.clickgui.impl.autobuy.items.ItemRegistry;
...
import static onix.command.impl.HelpCommand.getLine;
