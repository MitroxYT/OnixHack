...
import onix.events.impl.DrawEvent;
import onix.events.impl.TickEvent;
import onix.events.impl.WorldLoadEvent;
import onix.events.impl.WorldRenderEvent;
import onix.modules.impl.combat.AntiBot;
...
import onix.util.math.Projection;
import onix.util.modules.esp.RwPrefix;
import onix.util.network.Network;
import onix.util.render.Render2D;
import onix.util.render.font.Fonts;
import onix.util.render.item.ItemRender;
...
public class Esp extends ModuleStructure {
    ...
    Identifier TEXTURE = Identifier.of("onix", "textures/features/esp/container.png");
