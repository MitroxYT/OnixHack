...
import onix.events.impl.JumpEvent;
...
public class JumpCircle extends ModuleStructure implements IMinecraft {
    ...
    final Identifier circleTexture = Identifier.of("onix", "images/circle/circle.png");
    final Identifier glowTexture = Identifier.of("onix", "images/particle/glow.png");
