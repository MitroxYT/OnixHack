...
import onix.util.animations.Easings;
import onix.util.animations.SmoothAnimation;
...
public class Arrows extends ModuleStructure {
    ...
    private static final Identifier ARROW_TEXTURE = Identifier.of("onix", "textures/world/arrow.png");
