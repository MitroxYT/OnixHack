package onix.modules.impl.render.worldparticles;
...
import onix.IMinecraft;
import onix.util.ColorUtil;
import onix.util.animations.Animation;
import onix.util.animations.Direction;
import onix.util.animations.EaseInOutQuad;
import onix.util.render.сliemtpipeline.ClientPipelines;
...
public class Particle implements IMinecraft {
    ...
    private static final Identifier TEXTURE_CROWN = Identifier.of("onix", "textures/world/crown.png");
    private static final Identifier TEXTURE_CUBE_BLAST = Identifier.of("onix", "textures/world/cubeblast1.png");
    private static final Identifier TEXTURE_DOLLAR = Identifier.of("onix", "textures/world/dollar.png");
    private static final Identifier TEXTURE_HEART = Identifier.of("onix", "textures/world/heart.png");
    private static final Identifier TEXTURE_LIGHTNING = Identifier.of("onix", "textures/world/lightning.png");
    private static final Identifier TEXTURE_LINE = Identifier.of("onix", "textures/world/line.png");
    private static final Identifier TEXTURE_RHOMBUS = Identifier.of("onix", "textures/world/rhombus.png");
    private static final Identifier TEXTURE_SNOWFLAKE = Identifier.of("onix", "textures/world/snowflake.png");
    private static final Identifier TEXTURE_STAR = Identifier.of("onix", "textures/world/star.png");
    private static final Identifier TEXTURE_STAR_ALT = Identifier.of("onix", "textures/world/star1.png");
    private static final Identifier TEXTURE_TRIANGLE = Identifier.of("onix", "textures/world/triangle.png");
    private static final Identifier TEXTURE_GLOW = Identifier.of("onix", "textures/world/dashbloom.png");

    private static final Identifier GLOW_BLOOM = Identifier.of("onix", "textures/world/dashbloom.png");
    private static final Identifier GLOW_BLOOM_SAMPLE = Identifier.of("onix", "textures/world/dashbloomsample.png");
