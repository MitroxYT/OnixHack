...
public class ParticleRenderer {
    ...
    private static final Identifier GLOW_TEXTURE = Identifier.of("onix", "textures/world/dashbloom.png");
    private static final Identifier GLOW_TEXTURE_SECONDARY = Identifier.of("onix", "textures/world/dashbloomsample.png");
