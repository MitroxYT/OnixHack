...
import onix.modules.impl.combat.aura.attack.StrikeManager;
import onix.modules.impl.combat.aura.attack.StrikerConstructor;
import onix.modules.impl.combat.aura.impl.*;
import onix.modules.impl.combat.aura.impl.RotateConstructor;
import onix.modules.impl.combat.aura.rotations.*;
import onix.modules.impl.combat.aura.target.MultiPoint;
import onix.modules.impl.combat.aura.target.TargetFinder;
import onix.modules.impl.movement.ElytraTarget;
import onix.modules.module.ModuleStructure;
import onix.modules.module.category.ModuleCategory;
import onix.modules.module.setting.implement.*;
...
public class Aura extends ModuleStructure {
    ...
    private final SelectSetting mode = new SelectSetting("Режим наводки", "Select aim mode")
            .value("Matrix", "FunTime Snap", "Snap", "SpookyTime","Vertex")
            .selected("Matrix");
