...
public class FontRenderer {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("onix/FontRenderer");
    ...
    public void loadFont(String name, String path) {
        Identifier jsonId = Identifier.of("onix", "fonts/" + path + ".json");
        Identifier textureId = Identifier.of("onix", "fonts/" + path + ".png");
