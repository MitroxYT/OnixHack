...
public class OutlinePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("onix", "pipeline/outline");
    private static final Identifier VERTEX_SHADER = Identifier.of("onix", "core/outline");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("onix", "core/outline");
