...
public class BlurPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("onix", "pipeline/blur");
    private static final Identifier VERTEX_SHADER = Identifier.of("onix", "core/blur");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("onix", "core/blur");
