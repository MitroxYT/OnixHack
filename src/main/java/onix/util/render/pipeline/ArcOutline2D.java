    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("onix", "core/arc_outline"))
                    .withVertexShader(Identifier.of("onix", "core/arc_outline_vertex"))
                    .withFragmentShader(Identifier.of("onix", "core/arc_outline_fragment"))
