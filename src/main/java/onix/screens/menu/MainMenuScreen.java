...
import onix.screens.account.AccountEntry;
import onix.screens.account.AccountRenderer;
import onix.util.config.impl.account.AccountConfig;
import onix.util.render.Render2D;
import onix.util.render.font.Fonts;
import onix.util.session.SessionChanger;
import onix.util.sounds.SoundManager;
...
public class MainMenuScreen extends Screen {
    ...
    private static final Identifier BACKGROUND_TEXTURE = Identifier.of("onix", "textures/menu/backmenu.png");
