...
import onix.client.draggables.AbstractHudElement;
...
public class Staff extends AbstractHudElement {
    ...
    private static final Identifier STEVE_SKIN = Identifier.of("onix", "textures/entity/player/wide/steve.png");
