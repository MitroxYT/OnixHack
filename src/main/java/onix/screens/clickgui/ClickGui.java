...
import onix.Initialization;
import onix.modules.module.category.ModuleCategory;
import onix.modules.module.ModuleStructure;
import onix.screens.clickgui.impl.DragHandler;
import onix.screens.clickgui.impl.autobuy.autobuyui.AutoBuyRenderer;
import onix.screens.clickgui.impl.background.BackgroundComponent;
import onix.screens.clickgui.impl.configs.ConfigsRenderer;
import onix.screens.clickgui.impl.module.ModuleComponent;
import onix.screens.clickgui.impl.settingsrender.BindComponent;
import onix.screens.clickgui.impl.settingsrender.TextComponent;
import onix.util.animations.Direction;
import onix.util.animations.GuiAnimation;
import onix.util.interfaces.AbstractSettingComponent;
import onix.util.math.FrameRateCounter;
import onix.util.render.Render2D;
import onix.util.render.shader.Scissor;
import onix.util.render.gif.GifRender;
